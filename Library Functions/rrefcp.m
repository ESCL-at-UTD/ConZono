function [A_rref, ind] = rrefcp(A)
% rrefcp computes the Reduced row echelon form with complete pivoting of A.
% Inputs A - matrix.  

% Returns A_rref - matrix in reduced row echelon form with complete pivoting
% Columns of A are re-ordered per Gaussian elimination complete pivoting algorithm
% ind - Re-ordered column indices of A.
